...
import dd.app.computall.activities.DatabaseList;
...
public class Choose extends Base_Desktop {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.pcDatabase:
                startActivity(new Intent(this, DatabaseList.class));
                break;
            case R.id.addc:
    ...
    public void chooseDBPressed(View view) {
        ...
        if (app.dbManager.getDatabase().isEmpty()) {
            Toast.makeText(getApplicationContext(), "DatabaseList is Empty, Please Enter some Content", Toast.LENGTH_SHORT).show();
        } else {
            Intent intent = new Intent(Choose.this, DatabaseList.class);
